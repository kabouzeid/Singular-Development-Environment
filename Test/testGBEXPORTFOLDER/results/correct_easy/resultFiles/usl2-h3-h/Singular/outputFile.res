...
2(3)s(2)ss3-s4-s(5)s3(9)-s(10)--s(13)s(18)------s(16)-s(18)-s(19)---4---------------5-
(S:7)-------
product criterion:116 chain criterion:6
shift V criterion:231
=====Solution Begin=====
e*e,e*h+e,f*e-e*f+h,f*f,f*h-f,h*e-e,h*f+f,h*h-2*e*f+h
h,f,e
5
f*e-e*f+h,h*e-e*h-2*e,h*f-f*h+2*f,h*h*h-h
=====Solution End=====
